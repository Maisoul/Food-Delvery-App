...
import 'pages.dart' show FoodDeliveryApp, RegisterPage;
          ...
          TextButton(
              ...
              child: Padding(
                ...
                child: Text('Create new account',
                    style: TextStyle(
                        fontSize: 18,
                        color: AppThemes.primaryColor.withOpacity(0.9))),
              )),
          const SizedBox(height: 50)
        ],
      )))),
                  ...
                  ? () async {
                      ...
                      if (loginFormProvider.isValidForm()) {
                        ...
                        final String? errorMessage =
                            await authService.loginUser(loginFormProvider.email,
                                loginFormProvider.password);

                        if (errorMessage == null) {
                          Navigator.pushReplacementNamed(
                              context, FoodDeliveryApp.routeName);
                        } else {
